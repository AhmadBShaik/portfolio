    ...
    <div className="flex-1 max-w-7xl mx-auto">
      ...
      <div className="px-5 xl:px-0 sm:hidden">
        <div className="px-5 flex mt-5 space-x-5 bg-teal-50 bg-opacity-50 rounded w-fit py-1.5">
          <div className="flex items-center cursor-pointer">
            <a href="https://www.linkedin.com/in/ahmadbshaik/" target="_blank">
              <Image src={"/linkedin.png"} alt="LinkedIn" width={38} height={38} title="LinkedIn" />
            </a>
          </div>
          ...
          <div className="flex items-center cursor-pointer">
            <a href="https://github.com/ahmadbshaik" target="_blank">
              <Image src={"/github.png"} alt="GitHub" width={40} height={40} title="GitHub" />
            </a>
          </div>
        </div>
        <div className="mt-3.5">
          <a className="px-5 mt-5 rounded w-fit py-1.5 bg-teal-300 text-emerald-700 cursor-pointer font-bold" title="Resume" download={true} href="/Ahmad-Resume.pdf">Resume</a>
        </div>
      </div>
      <div className="px-5 xl:px-0 hidden sm:flex items-center space-x-5">
        <div className="px-5 flex mt-5 space-x-5 bg-teal-50 bg-opacity-50 rounded w-fit py-2.5">
          <div className="flex items-center cursor-pointer">
            <a href="https://www.linkedin.com/in/ahmadbshaik/" target="_blank">
              <Image src={"/linkedin.png"} alt="LinkedIn" width={45} height={45} title="LinkedIn" />
            </a>
          </div>
          {/* <div className="flex items-center cursor-pointer"><Image src={"/gmail.png"} alt="Gmail" width={52} height={52} title="Email" /></div> */}
          <div className="flex items-center cursor-pointer">
            <a href="https://github.com/ahmadbshaik" target="_blank">
              <Image src={"/github.png"} alt="GitHub" width={50} height={50} title="GitHub" />
            </a>
          </div>
          <div className="flex items-center cursor-pointer" >
            <a className="px-5 rounded w-fit py-1.5 bg-emerald-700 text-teal-200 cursor-pointer font-bold" title="Resume" download={true} href="/Ahmad-Resume.pdf">Resume</a>
          </div>
        </div>
      </div>
    </div>
