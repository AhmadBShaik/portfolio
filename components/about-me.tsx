    ...
    <section
      ...
      <div className="space-y-5">
        ...
        <p>
          ...
          challenges. I have experience of building micro applications from
          scratch.
        </p>
        <p>
        ...
        <div className="md:hidden flex flex-col text-sm pt-10">
          ...
          <>
            <div className="flex">
              <div
                className={`w-10 flex flex-col items-center mr-2.5 text-emerald-700 text-xs`}></div>
              <div>
                <div className="flex items-center">
                  <div
                    className={`h-3 w-3 rounded-full bg-emerald-700 animate-bounce  z-10 -ml-1 mb-1`}></div>
        ...
        <div className="hidden md:flex flex-col items-center md:text-md pt-16">
          ...
          <>
            <div className="flex w-full items-center">
              ...
              <div
                className={`h-3 w-3 rounded-full bg-emerald-700 animate-bounce z-10`}></div>
              <div className="flex-1"></div>
            </div>
            <div className="flex w-full">
              <div className="flex-1"></div>
              <div
                className={`h-10 w-1 mt-2 rounded-full  bg-emerald-500 flex items-center`}></div>
              <div className="flex-1"></div>
            </div>
          </>
          <>
