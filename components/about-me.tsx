  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        ...
        <p>
          My passion lies in coding and developing solutions to real-world
          challenges. I have experience in building micro applications from
          scratch.
        </p>
        <p>
          I started programming {`${new Date().getFullYear() - 2018}`} years
          ago. Since I started programming, I am always trying to find mentors
        ...
        <div className="md:hidden flex flex-col text-sm pt-10">
          ...
          <>
            <div className="flex">
              <div
                className={`w-10 flex flex-col items-center mr-2.5 text-emerald-700 text-xs`}
              ></div>
              <div>
                <div className="flex items-center">
                  <div
                    className={`h-3 w-3 rounded-full bg-emerald-700 animate-bounce  z-10 -ml-1 mb-1`}
                  ></div>

                  <div className=" mx-2.5 font-bold"></div>
                </div>
                <div className="h-8 w-1 rounded-full bg-emerald-500 flex items-center"></div>
              </div>
            </div>
          </>
          <>
            <div className="flex">
              ...
              <div>
                <div className="flex items-center">
                  <div className="h-3 w-3 rounded-full bg-emerald-700 z-10 -ml-1"></div>

                  <div className=" mx-2.5 font-bold">👨🏻‍💻 Software Engineer</div>
                </div>
                <div className="h-20 w-1 rounded-full bg-emerald-500 flex items-center"></div>
              </div>
            </div>
          </>
          <>
        ...
        <div className="hidden md:flex flex-col items-center md:text-md pt-16">
          ...
          <>
            <div className="flex w-full items-center">
              <div className="flex-1 flex justify-end rounded"></div>
              <div
                className={`h-3 w-3 rounded-full bg-emerald-700 animate-bounce z-10`}
              ></div>
            ...
            <div className="flex w-full">
              <div className="flex-1"></div>
              <div
                className={`h-10 w-1 mt-2 rounded-full  bg-emerald-500 flex items-center`}
              ></div>
              <div className="flex-1"></div>
            </div>
          </>
          ...
          <>
            <div className="flex w-full items-center">
              <div className="flex-1 flex justify-end rounded">
                <div className=" mx-5 font-bold">Software Engineer 👨🏻‍💻</div>
              </div>
